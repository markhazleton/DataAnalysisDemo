        ...
        For Each myPart As Part In PartList
            If myPart.PartCategoryID = CurrentCID Then
                ...
                If myPart.PartSource = "SiteLink" Then
                    ...
                    ElseIf myPart.CompanyID = String.Empty Then
                        sbLinks.Append(String.Format("<a href=""/admin/maint/default.aspx?type=Part&PartID={0}"" class=""list-group-item highlight-two"">{1}</a>", myPart.PartID, sLocationInfo))
