...
Public Class DisplayTableHeader
    ...
    Private Function FormatHeaderColumn(ByVal myColName As String) As String
        ...
        Select Case Right(myColName, 2)
            Case "NM"
                newColumnName = Left(myColName, Len(myColName) - 2) & " DisplayName"
            Case "CD"
    ...
    'Public Sub AddHeaderItem(ByVal DisplayName As String, ByVal Value As String)
    '    HeaderItems.Add(New DisplayTableHeaderItem With {.DisplayName = DisplayName, 
    '                                                     .Value = Value})
    'End Sub
    'Public Sub AddHeaderItem(ByVal DisplayName As String, ByVal Value As String, ByVal LinkPath As String, ByVal LinkKeyName As String, ByVal LinkTextName As String )
    '    HeaderItems.Add(New DisplayTableHeaderItem With {.DisplayName = DisplayName, 
    '                                                     .Value = Value,
    '                                                     .KeyField = True,
    '                                                     .LinkKeyName = LinkKeyName,
    ...
    '                ReturnHeader.AddHeaderItem(pInfo.DisplayName, pInfo.DisplayName)
    '            Next
    ...
    '                myrow.Append(AddComma(p.DisplayName) & ",")
    '                iRow += 1
    '            Else
    '                myrow.Append(AddComma(p.DisplayName))
